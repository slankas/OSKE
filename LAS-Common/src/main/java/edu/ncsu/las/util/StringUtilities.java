...
public class StringUtilities {
	...
	public static String IMPROPER_NAME_REGEX = "[^a-zA-Z_ \\-,0-9\\.\\(\\)]+";
	private static Pattern IMPROPER_NAME_PATTERN = Pattern.compile(IMPROPER_NAME_REGEX);
	...
	public static boolean isAlphaNumberWithLimitedSpecialCharacters(String text) {
			return !(IMPROPER_NAME_PATTERN.matcher(text).find());
	}
	
	/**
	 * Converts an array to a single string by calling "toString()" on each element.
	 * 
	 * @param array
	 * @param sep
	 * @return joinedString
