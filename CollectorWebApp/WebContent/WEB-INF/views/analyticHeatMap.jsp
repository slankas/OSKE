...
<% pageContext.setAttribute("currentPage","domain.analyze.heatMap"); %>

<title>Collector: Analytic HeatMap</title>
			...
			<div class="form-group col-md-8">
				<div class="form-inline">
					<div class="form-group">
						<label for="xAxisField">X-axis</label> <select id='xAxisField'
							class="form-control input-sm select-dropdown"
							style="width: 180px"></select> <input type="text"
							class="form-control" id="xAxisSize" placeholder="set size"
							title="optional-set x axis size" size=5>
					</div>
					<div class="form-group">
						<label for="yAxisField">Y-axis</label> <select id='yAxisField'
							class="form-control input-sm select-dropdown"
							style="width: 180px"></select> <input type="text"
							class="form-control" id="yAxisSize" placeholder="set size"
							title="optional-set y axis size" size=5>
					</div>
...
<script type="text/javascript" charset="utf8" src="${applicationRoot}resources/js/application/analyticHeatMap.js?build=${build}"></script>
