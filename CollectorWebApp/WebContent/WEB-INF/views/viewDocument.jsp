...
<% pageContext.setAttribute("currentPage","noheader.viewDocument"); %>
...
<script type="text/javascript" charset="utf8" src="${applicationRoot}resources/js/viewDocument.js?build=${build}"></script>
