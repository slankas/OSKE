...
<% pageContext.setAttribute("currentPage","domain.manage.conceptImport"); %>
...
<div class="row" id="fileUploadSection">
    <div class="col-lg-12">
		<form id="fileupload" action='"${applicationRoot}rest/<%=domain%>/concepts/upload' method="POST"
			...
			<div class="fileupload-buttonbar">
					...
					<span class="btn btn-primary fileinput-button"> <i
						class="fas fa-plus"></i> <span>Add files...</span> <input
						type="file" name="files[]" multiple type="submit" id="addFiles">
					</span>
					<button name="btnClearAll" id="btnClearAll" type="reset"
						class="btn btn-clear cancel" onclick="clearFiles()">
						<i class="fas fa-trash-alt"></i> <span>Clear All</span>
					</button>
					<button style="visibility: hidden;" name="btnCancel" id="btnCancel"
						type="reset" class="btn btn-warning cancel">
						<i class="fas fa-ban-circle"></i> <span>Cancel
							upload</span>
					</button>
...
<div class="row">
	<div class="col-md-12">
		<div class="floatleft">
			<button type="submit" class="btn btn-primary" id="btnConcepts">Concepts</button>&nbsp;
...
<script type="text/javascript" charset="utf8" src="${applicationRoot}resources/js/application/conceptImportScript.js?build=${build}"></script>
