...
public class MimeTypeMap {
    ...
    public String getMimeTypeFromExtension(String extension) {
        if (extension != null && extension.length() > 0) {
            return mExtensionToMimeTypeMap.get(extension.toLowerCase());
        }
        return null;
    }
    // Static method called by jni.
    public static String mimeTypeFromExtension(String extension) {
        return getSingleton().getMimeTypeFromExtension(extension.toLowerCase());
    }
    /**
    ...
    public boolean hasExtension(String extension) {
        if (extension != null && extension.length() > 0) {
            return mExtensionToMimeTypeMap.containsKey(extension.toLowerCase());
        }
        return false;
    }
    /**
    ...
    public static MimeTypeMap getSingleton() {
        if (sMimeTypeMap == null) {
            ...
            sMimeTypeMap.loadEntry("application/epub+zip", "epub");
