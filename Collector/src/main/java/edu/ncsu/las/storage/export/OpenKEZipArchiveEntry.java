...
public class OpenKEZipArchiveEntry  {
	private static Logger logger =Logger.getLogger(OpenKEZipArchiveEntry.class.getName());

	public static  Map<String, byte[]> createZipEntry(JSONObject record, Format format, String grouping, String naming, boolean eliminateNonSentences, boolean removeNonASCII, boolean stemText) {
		...
		Map<String, byte[]> zae = new HashMap<String, byte[]>();
		zae.put(name, content);
